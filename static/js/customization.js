  ...
  const e = {
    ...
    init() {
      this.generateButtons(),
        this.setActiveButton('green'),
        this.generateTheme('green')
    },
    generateButtons() {
      let e = '',
        a = ''
      for (const c in this.colors)
        (e += '<button data-color="'
          .concat(c, '" aria-label="Activate ')
          .concat(c, ' theme"></button>')),
          (a += '\n        button[data-color="'
            .concat(c, '"] {\n          background-color: ')
            .concat(
              this.colors[c][600],
      ...
      t.setAttribute('title', 'color-picker'),
        (this.generatedStyles = this.minifyCSS(a)),
        (t.innerHTML = this.generatedStyles),
    ...
    setActiveButton(e) {
      ...
      let a = document.querySelector(
        this.selectorButton + '[data-color="' + e + '"]'
      )
      a.setAttribute('class', 'picked')
    },
    generateTheme(e) {
      let a = e
      e = this.colors[e]
      ...
      Object.keys(f).forEach(a => {
        let e = document.querySelectorAll(this.selectorSection + ' ' + a)
        e.forEach(e => {
          e.innerHTML = f[a]
        })
      })
      e = '\n    [data-theme="generated"] {\n      --h4-color: '
        ...
        .concat(e[600], ';\n      --primary-hover: ')
        .concat(e[700], ';\n      --primary-focus: ')
        .concat(this.hexToRgbA(e[600], 0.125), ';\n      --primary-inverse: ')
        .concat(
          e.inverse,
        ...
        .concat(e[600], ';\n        --primary-hover: ')
        .concat(e[500], ';\n        --primary-focus: ')
        .concat(this.hexToRgbA(e[600], 0.25), ';\n        --primary-inverse: ')
        .concat(
          e.inverse,
      ...
      document.querySelector('style[title="color-picker"]').innerHTML =
        this.generatedStyles + this.minifyCSS(e)
    },
    minifyCSS(e) {
      return e.replace(/^ +/gm, '')
    },
